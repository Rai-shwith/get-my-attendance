...
exports.hash = async (item) => {
  logger.debug("Hashing the item");
...
exports.verifyHash = async (enteredItem, storedHashedItem) => {
  const isMatch = await bcrypt.compare(enteredItem, storedHashedItem);
  logger.debug("Hash Match :" + isMatch)
